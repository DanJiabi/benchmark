...
def main():
    ...
    print()
    print("3. 所有 baseline vs 单用户模型（推荐）:")
    print(
        "   od-benchmark analyze --all-baselines --user-model yolov8n:simulated --num-images 50"
    )
    print()
    print("4. 单 baseline vs 多用户模型:")
    print(
        "   od-benchmark analyze --baseline yolov8n --user-model yolov8s --user-model yolov8m --num-images 100"
    )
    print()
    print("5. 所有 baseline vs 多用户模型（完整对比）:")
    print(
        "   od-benchmark analyze --all-baselines --user-model yolov8s --user-model yolov8m --num-images 200"
    )
    print()
    print("预期结果:")
